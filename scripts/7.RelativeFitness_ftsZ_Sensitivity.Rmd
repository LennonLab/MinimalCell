...
## fitness of fitZ mutants depicted in FigExt3
...
```{r}
# Make figure
png(filename="~/GitHub/MinimalCell/figures/4.figshare/2.delta_cell_size.regate.png",
...
# Show Plot
img <- readPNG("~/GitHub/MinimalCell/figures/4.figshare/2.delta_cell_size.regate.png")
...
calcsheet17_6 <- mutate(calcsheet17_5, W_W_calculated = log(T24_SOI_calculated / 
        T0_SOI_per_inoculated_V_calculated) / log(T24_mCherry_calculated /
        T0_mCherry_per_inoculated_V_calculated))
...
calcsheet19_2 <- mutate(calcsheet19, ratio_false_negs_per_true_pos_calculated=mCherry_false_negs_avg /
        mCherry_true_posvs_avg)
...
calcsheet19_7 <- mutate(calcsheet19_6, W_W_calculated =
        log(T24_SOI_calculated/T0_SOI_calculated) / log(T24_mCherry_calculated/T0_mCherry_calculated))
```
