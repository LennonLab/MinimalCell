...
# Composition of mutated genes during experimental evolution (Fig. 3)
...
```{r}
g.essent.adonis <- adonis2(g.essent ~ g.essent.raw$treatment, method = "bray", permutations = 9999)
...
```{r, results = "hide"}
png(filename="~/GitHub/MinimalCell/figures/1.main.text/Fig3.png",
...
# Show Plot
img <- readPNG("~/GitHub/MinimalCell/figures/1.main.text/Fig3.png")
grid.raster(img)
```