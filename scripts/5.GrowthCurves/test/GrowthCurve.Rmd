...
# Growth curves to estimate fitness components (Extended Data Fig. 1, Fig. S2, Figshare)
...
write.table(parms, "~/Github/MinimalCell/scripts/5.GrowthCurves/output/GrowthCurveParms.txt", 
    sep = "\t", row.names = FALSE)
```
...
# Diagnostics of growth curves (Figshare)
